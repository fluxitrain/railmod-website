...
const news = [
  {
    id: 1,
    title: "Dépôt et livrées en développement",
    excerpt:
      "Le dépôt ferroviaire RFR est en cours de construction et les livrées des trains sont en cours de création. Restez informés !",
    date: "6 mai 2025",
  ...
  {
    id: 2,
    title: "Système de comptes disponible",
    excerpt:
      "Vous pouvez maintenant créer un compte pour participer aux discussions et suivre votre progression.",
    date: "6 mai 2025",
    category: "Nouveauté",
    featured: false,
  },
  {
    ...
    excerpt:
      "Notre serveur Discord officiel est maintenant disponible ! Rejoignez la communauté pour discuter et rester informé.",
    date: "6 mai 2025",
    category: "Communauté",
    featured: false,
  },
