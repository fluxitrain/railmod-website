...
const stats = [
  { value: "0", label: "Lignes", status: "En dev" },
  { value: "0", label: "Gares", status: "En dev" },
  { value: "0", label: "Trains", status: "En dev" },
]
      ...
      <div className="relative container mx-auto px-4 pt-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-muted-foreground mb-4 max-w-2xl text-pretty"
          >
          ...
          <motion.div
            ...
            className="mb-8 px-4 py-3 rounded-lg bg-accent/10 border border-accent/30 max-w-xl"
          >
            <p className="text-sm text-accent font-medium">
              Le dépôt et les trains RFR sont actuellement en développement
            </p>
          </motion.div>
